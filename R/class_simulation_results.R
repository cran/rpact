...
SimulationResultsMeans <- setRefClass("SimulationResultsMeans",
	...
	fields = list(
		...
		minNumberOfAdditionalSubjectsPerStage = "numeric",
		maxNumberOfAdditionalSubjectsPerStage = "numeric", 
...
SimulationResultsSurvival <- setRefClass("SimulationResultsSurvival",
	...
	fields = list(
		...
		allocation1 = "numeric",
		allocation2 = "numeric",
		minNumberOfAdditionalEventsPerStage = "numeric",
		maxNumberOfAdditionalEventsPerStage = "numeric", 
		conditionalPower = "numeric", 
		thetaH1 = "numeric", 
		maxNumberOfIterations = "integer", 
		kappa = "numeric",
