...
test_that("'formatPValues'", {
	...
	## Comparison of the results of character object 'x' with expected results
	##
	expect_equal(x, c("0.0002346", "0.0000134", "0.1234000", "<0.0000001", "<0.0000001"))
	...
	## Comparison of the results of character object 'x' with expected results
	##
	expect_equal(x, c("0.002340", "0.000013", "0.123400", "<0.00001", "<0.00001"))
	...
	## Comparison of the results of character object 'x' with expected results
	##
	expect_equal(x, c("6.244e-05", "4.906e-02", "1.446e-02", "NA"))
