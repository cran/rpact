...
test_that("'getSimulationSurvival': configuration 2", {
	...
	expect_equal(simulationResults$eventsPerStage[3, ], c(155.08333, 173.61035, 233.02747, 248.03712), tolerance = 1e-07)
...
test_that("'getSimulationSurvival': configuration 3", {
	...
	expect_equal(simulationResults$eventsPerStage[3, ], c(261.75049, 192.20833, 218.96368, 131.48), tolerance = 1e-07)
	expect_equal(simulationResults$conditionalPowerAchieved[1, ], c(NA_real_, NA_real_, NA_real_, NA_real_))
...
test_that("'getSimulationSurvival': configuration 4", {
	...
	expect_equal(simulationResults$eventsPerStage[3, ], 203.4614, tolerance = 1e-07)
...
test_that("'getSimulationSurvival': configuration 5", {
	...
	expect_equal(simulationResults$eventsPerStage[3, ], c(74.929119, 85.120621, 92.285607, 93.582208), tolerance = 1e-07)
	expect_equal(simulationResults$conditionalPowerAchieved[1, ], c(NA_real_, NA_real_, NA_real_, NA_real_))
...
test_that("'getSimulationSurvival': configuration 6", {
	...
	expect_equal(simulationResults$eventsPerStage[1, ], 20)
	expect_equal(simulationResults$eventsPerStage[2, ], 125.21053, tolerance = 1e-07)
	expect_equal(simulationResults$eventsPerStage[3, ], 222.51822, tolerance = 1e-07)
	expect_equal(simulationResults$conditionalPowerAchieved[1, ], NA_real_)
...
test_that("'getSimulationSurvival': configuration 7", {
	...
	expect_equal(simulationResults$eventsPerStage[1, ], 20)
	expect_equal(simulationResults$eventsPerStage[2, ], 107.53, tolerance = 1e-07)
	expect_equal(simulationResults$eventsPerStage[3, ], 200.90634, tolerance = 1e-07)
	expect_equal(simulationResults$conditionalPowerAchieved[1, ], NA_real_)
...
test_that("'getSimulationSurvival': configuration 9; ", {
	...
	expect_equal(simulationResults$eventsPerStage[1, ], 20)
	expect_equal(simulationResults$eventsPerStage[2, ], 106.16162, tolerance = 1e-07)
	expect_equal(simulationResults$eventsPerStage[3, ], 195.73633, tolerance = 1e-07)
	expect_equal(simulationResults$conditionalPowerAchieved[1, ], NA_real_)
...
test_that("'getSimulationSurvival': configuration 10; ", {
	...
	expect_equal(simulationResults$eventsPerStage[2, ], c(105.16, 109.35354, 112.36364), tolerance = 1e-07)
	expect_equal(simulationResults$eventsPerStage[3, ], c(197.16, 199.53535, 210.98729), tolerance = 1e-07)
...
test_that("'getSimulationSurvival': Perform recalculation of number of events based on conditional power", {
	...
	expect_equal(resultsWithSSR1$eventsPerStage[3, ], c(408.93125, 400.78042, 383.94227, 378.3343, 365.87292, 369.8482, 353.17292), tolerance = 1e-07)
	...
	expect_equal(resultsWithSSR2$eventsPerStage[3, ], c(403.59889, 392.21263, 361.25783, 350.23829, 321.46875, 311.49495, 272.08592), tolerance = 1e-07)
