...
#                                                                                    #
# File version: 1.0.0                                                                #
# Date: 11 September 2019, 13:38:41                                                  #
...
test_that("'getAnalysisResults' produces the correct exact tests and final CIs", {
	...
	expect_equal(x1$allocationRatioPlanned, 1)
	expect_equal(x1$pi1, 0.68888889, tolerance = 1e-07)
	expect_equal(x1$pi2, 0.44347826, tolerance = 1e-07)
	...
	expect_equal(x2$allocationRatioPlanned, 1)
	expect_equal(x2$pi1, 0.68888889, tolerance = 1e-07)
	expect_equal(x2$pi2, 0.44347826, tolerance = 1e-07)
	...
	expect_equal(x3$allocationRatioPlanned, 1)
	expect_equal(x3$pi1, 0.68888889, tolerance = 1e-07)
	expect_equal(x3$pi2, 0.44347826, tolerance = 1e-07)
...
test_that("'getAnalysisResults' produces the correct exact tests and final CIs", {
	...
	expect_equal(x1$nPlanned, c(NA_real_, NA_real_))
	expect_equal(x1$allocationRatioPlanned, 1)
	expect_equal(x1$pi1, 0.44347826, tolerance = 1e-07)
	expect_equal(x1$pi2, 0.68888889, tolerance = 1e-07)
	expect_equal(x1$conditionalPower, c(NA_real_, NA_real_))
	...
	expect_equal(x2$nPlanned, c(NA_real_, NA_real_))
	expect_equal(x2$allocationRatioPlanned, 1)
	expect_equal(x2$pi1, 0.44347826, tolerance = 1e-07)
	expect_equal(x2$pi2, 0.68888889, tolerance = 1e-07)
	expect_equal(x2$conditionalPower, c(NA_real_, NA_real_))
	...
	expect_equal(x3$nPlanned, c(NA_real_, NA_real_))
	expect_equal(x3$allocationRatioPlanned, 1)
	expect_equal(x3$pi1, 0.44347826, tolerance = 1e-07)
	expect_equal(x3$pi2, 0.68888889, tolerance = 1e-07)
	expect_equal(x3$conditionalPower, c(NA_real_, NA_real_))
