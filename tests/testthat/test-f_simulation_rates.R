...
test_that("'getSimulationRates': check several configurations", {
	...
	expect_equal(x1$conditionalPowerAchieved[1, ], c(NA_real_, NA_real_, NA_real_, NA_real_), tolerance = 1e-07)
	...
	expect_equal(x2$conditionalPowerAchieved[1, ], c(NA_real_, NA_real_, NA_real_, NA_real_), tolerance = 1e-07)
	...
	expect_equal(x3$conditionalPowerAchieved[1, ], c(NA_real_, NA_real_, NA_real_, NA_real_, NA_real_), tolerance = 1e-07)
	...
	expect_equal(x4$conditionalPowerAchieved[1, ], c(NA_real_, NA_real_, NA_real_, NA_real_, NA_real_), tolerance = 1e-07)
	...
	expect_equal(x5$conditionalPowerAchieved[1, ], c(NA_real_, NA_real_, NA_real_, NA_real_), tolerance = 1e-07)
	...
	expect_equal(x6$conditionalPowerAchieved[1, ], c(NA_real_, NA_real_, NA_real_, NA_real_, NA_real_), tolerance = 1e-07)
	...
	expect_equal(x7$sampleSizes[1, ], c(30, 30, 30, 30, 30), tolerance = 1e-07)
	...
	expect_equal(x7$conditionalPowerAchieved[1, ], c(NA_real_, NA_real_, NA_real_, NA_real_, NA_real_), tolerance = 1e-07)
	...
	expect_equal(x8$sampleSizes[1, ], c(100, 100, 100, 100, 100), tolerance = 1e-07)
	...
	expect_equal(x8$conditionalPowerAchieved[1, ], c(NA_real_, NA_real_, NA_real_, NA_real_, NA_real_), tolerance = 1e-07)
	...
	expect_equal(x9$sampleSizes[1, ], c(100, 100, 100, 100, 100, 100), tolerance = 1e-07)
	...
	expect_equal(x9$conditionalPowerAchieved[1, ], c(NA_real_, NA_real_, NA_real_, NA_real_, NA_real_, NA_real_), tolerance = 1e-07)
	...
	expect_equal(x10$sampleSizes[1, ], c(40, 40, 40, 40), tolerance = 1e-07)
	...
	expect_equal(x10$conditionalPowerAchieved[1, ], c(NA_real_, NA_real_, NA_real_, NA_real_), tolerance = 1e-07)
